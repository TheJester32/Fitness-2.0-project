...
var pashkov = document.querySelector('.pashkov');
...
pashkov.addEventListener('mouseout', function () {
...
function _interopRequireWildcard(obj, nodeInterop) { if (!nodeInterop && obj && obj.__esModule) { return obj; } if (obj === null || _typeof(obj) !== "object" && typeof obj !== "function") { return { default: obj }; } var cache = _getRequireWildcardCache(nodeInterop); if (cache && cache.has(obj)) { return cache.get(obj); } var newObj = {}; var hasPropertyDescriptor = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var key in obj) { if (key !== "default" && Object.prototype.hasOwnProperty.call(obj, key)) { var desc = hasPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : null; if (desc && (desc.get || desc.set)) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } newObj.default = obj; if (cache) { cache.set(obj, newObj); } return newObj; }
_swiper.default.use([_swiper.Navigation]);
var swiper = new _swiper.default('.swiper-comments', {
  direction: 'horizontal',
  loop: true,
  navigation: {
    nextEl: '.swiper-button-next',
...
},{"swiper":91}],95:[function(require,module,exports){
"use strict";

var sections = document.querySelectorAll('.faq__upper-item');
var services = document.querySelector('.services');
var center = document.querySelector('.center');
var sub = document.querySelector('.sub');
var rules = document.querySelector('.rules');
var firstServicesClose = document.querySelector('.faq__services-first-close');
var firstServicesOpen = document.querySelector('.faq__services-first-open');
var secondServicesClose = document.querySelector('.faq__services-second-close');
var secondServicesOpen = document.querySelector('.faq__services-second-open');
var thirdServicesClose = document.querySelector('.faq__services-third-close');
var thirdServicesOpen = document.querySelector('.faq__services-third-open');
var fourthServicesClose = document.querySelector('.faq__services-fourth-close');
var fourthServicesOpen = document.querySelector('.faq__services-fourth-open');
var firstCenterClose = document.querySelector('.faq__center-first-close');
var firstCenterOpen = document.querySelector('.faq__center-first-open');
var secondCenterClose = document.querySelector('.faq__center-second-close');
var secondCenterOpen = document.querySelector('.faq__center-second-open');
var thirdCenterClose = document.querySelector('.faq__center-third-close');
var thirdCenterOpen = document.querySelector('.faq__center-third-open');
var fourthCenterClose = document.querySelector('.faq__center-fourth-close');
var fourthCenterOpen = document.querySelector('.faq__center-fourth-open');
var firstSubClose = document.querySelector('.faq__sub-first-close');
var firstSubOpen = document.querySelector('.faq__sub-first-open');
var secondSubClose = document.querySelector('.faq__sub-second-close');
var secondSubOpen = document.querySelector('.faq__sub-second-open');
var thirdSubClose = document.querySelector('.faq__sub-third-close');
var thirdSubOpen = document.querySelector('.faq__sub-third-open');
var fourthSubClose = document.querySelector('.faq__sub-fourth-close');
var fourthSubOpen = document.querySelector('.faq__sub-fourth-open');
var firstRulesClose = document.querySelector('.faq__rules-first-close');
var firstRulesOpen = document.querySelector('.faq__rules-first-open');
var secondRulesClose = document.querySelector('.faq__rules-second-close');
var secondRulesOpen = document.querySelector('.faq__rules-second-open');
var removeDefaultSection = function removeDefaultSection() {
...
firstServicesOpen.addEventListener('click', function () {
...
firstServicesClose.addEventListener('click', function () {
...
secondServicesOpen.addEventListener('click', function () {
...
secondServicesClose.addEventListener('click', function () {
...
thirdServicesOpen.addEventListener('click', function () {
...
thirdServicesClose.addEventListener('click', function () {
...
fourthServicesOpen.addEventListener('click', function () {
...
fourthServicesClose.addEventListener('click', function () {
...
firstCenterOpen.addEventListener('click', function () {
...
firstCenterClose.addEventListener('click', function () {
...
secondCenterOpen.addEventListener('click', function () {
...
secondCenterClose.addEventListener('click', function () {
...
thirdCenterOpen.addEventListener('click', function () {
...
thirdCenterClose.addEventListener('click', function () {
...
fourthCenterOpen.addEventListener('click', function () {
...
fourthCenterClose.addEventListener('click', function () {
...
firstSubOpen.addEventListener('click', function () {
...
firstSubClose.addEventListener('click', function () {
...
secondSubOpen.addEventListener('click', function () {
...
secondSubClose.addEventListener('click', function () {
...
thirdSubOpen.addEventListener('click', function () {
...
thirdSubClose.addEventListener('click', function () {
...
fourthSubOpen.addEventListener('click', function () {
...
fourthSubClose.addEventListener('click', function () {
...
firstRulesOpen.addEventListener('click', function () {
...
firstRulesClose.addEventListener('click', function () {
...
secondRulesOpen.addEventListener('click', function () {
...
secondRulesClose.addEventListener('click', function () {
...
var play = document.querySelector('.gym__play');
var video = document.querySelector('.gym__video');
var picture = document.querySelector('.gym__second-picture');
var preview = document.querySelector('.gym__video-preview');
...
require("./coaches-swiper.js");
require("./coahes.js");
require("./faq.js");
require("./comments-swiper.js");
require("./form.js");
// ---------------------------------
...
},{"./coaches-swiper.js":92,"./coahes.js":93,"./comments-swiper.js":94,"./faq.js":95,"./form.js":96,"./gym.js":97,"./membership.js":99,"./modules/form-validate/form":101,"./modules/modals/init-modals":107,"./utils/ios-vh-fix":111}],99:[function(require,module,exports){
"use strict";

var months = document.querySelectorAll('.membership__months');
...
},{"./callback":100,"./init-phone-input":102,"./validator":106}],102:[function(require,module,exports){
"use strict";
...
},{"./matrix":103,"./regular-expression":104,"./render-message":105}],107:[function(require,module,exports){
"use strict";
...
},{"./modals":108}],108:[function(require,module,exports){
"use strict";
...
},{"../../utils/focus-lock":109,"../../utils/scroll-lock":112}],109:[function(require,module,exports){
"use strict";
...
},{"./ios-checker":110}],112:[function(require,module,exports){
"use strict";
